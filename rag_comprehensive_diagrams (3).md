...
flowchart TD
    ...
    classDef setupStyle fill:#e8f5e8,stroke:#4caf50,stroke-width:2px
    classDef initStyle fill:#e3f2fd,stroke:#2196f3,stroke-width:2px
    classDef processStyle fill:#fff3e0,stroke:#ff9800,stroke-width:2px
    classDef searchStyle fill:#f3e5f5,stroke:#9c27b0,stroke-width:2px
    
    class A,B setupStyle
    class C,D,E initStyle
