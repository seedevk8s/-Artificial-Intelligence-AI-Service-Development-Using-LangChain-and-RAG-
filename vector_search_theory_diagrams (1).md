...
graph TD
    ...
    subgraph "HNSW 특징"
        ...
        HNSW_ROOT --> HNSW_GRAPH
        HNSW_ROOT --> HNSW_UPDATE
        HNSW_ROOT --> HNSW_PERF
        HNSW_ROOT --> HNSW_STD
    end
    ...
    subgraph "실무 고려사항"
        ...
        DATA_SIZE[데이터 규모]
        SEARCH_FREQ[검색 빈도]
        ACCURACY_REQ[정확도 요구사항]
        RESOURCE[시스템 자원]
        UPDATE_PATTERN[업데이트 패턴]
        
        CONSIDER --> DATA_SIZE
        CONSIDER --> SEARCH_FREQ
        CONSIDER --> ACCURACY_REQ
        CONSIDER --> RESOURCE
        CONSIDER --> UPDATE_PATTERN
    end
    
    classDef knnStyle fill:#ffebee,stroke:#c62828,stroke-width:2px
    classDef annStyle fill:#e8f5e8,stroke:#2e7d32,stroke-width:2px
    classDef hnswStyle fill:#e3f2fd,stroke:#1976d2,stroke-width:2px
    classDef considerStyle fill:#fff3e0,stroke:#f57c00,stroke-width:2px
    
    class KNN_ROOT,KNN_ACC,KNN_TIME,KNN_DATA,KNN_IMPL knnStyle
    class ANN_ROOT,ANN_ACC,ANN_TIME,ANN_DATA,ANN_INDEX annStyle
    class HNSW_ROOT,HNSW_GRAPH,HNSW_UPDATE,HNSW_PERF,HNSW_STD hnswStyle
    class CONSIDER,DATA_SIZE,SEARCH_FREQ,ACCURACY_REQ,RESOURCE,UPDATE_PATTERN considerStyle
```
